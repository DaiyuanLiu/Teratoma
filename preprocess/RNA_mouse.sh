...
## Alignment STAR
/share/home/hanxiaoping/tools/STAR-2.5.2a/source/STAR --genomeDir /share/home/hanxiaoping/tools/STAR_Reference_Mouse/genomeDir/ --readFilesIn unaligned_mc_tagged_polyA_filtered.fastq --outFileNamePrefix star
...
## MergeBamAlignment
java -Xmx100g -jar /share/home/hanxiaoping/tools/Drop-seq_tools-1.12/3rdParty/picard/picard.jar MergeBamAlignment REFERENCE_SEQUENCE=/share/home/hanxiaoping/tools/STAR_Reference_Mouse/genomeDir/Mus_musculus.GRCm38.88.fasta UNMAPPED_BAM=filtered.bam ALIGNED_BAM=aligned.sorted.bam OUTPUT=merged.bam INCLUDE_SECONDARY_ALIGNMENTS=false PAIRED_RUN=false

## TagReadWithGeneExon
/share/home/hanxiaoping/tools/Drop-seq_tools-1.12/TagReadWithGeneExon I=merged.bam O=star_gene_exon_tagged.bam ANNOTATIONS_FILE=/share/home/hanxiaoping/tools/STAR_Reference_Mouse/genomeDir/Mus_musculus.GRCm38.88.gtf TAG=GE
